...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    //5: Aumente a velocidade em 3 vezes o número anterior.
    ...
    // 1 pular quando a tecla espaço for pressionada
...
function spawnObstacles(){
 if (frameCount % 60 === 0){
   ...
   // 4: Aumente a velocidade do obstáculo.
